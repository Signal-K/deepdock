---
title: Product Hunt 1st Launch Prep
...
## 📋 Pre-Launch Checklist (3+ months before)
...
**Tagline** (max 60 characters - clear, no gimmicks)
- Draft 1: _______________
- Draft 2: _______________
- Draft 3: _______________
- **Final:** _______________

**Description** (max 500 characters)
```
Draft your description here:
...
**Gallery Images** (minimum 2 required - 1270x760 recommended)
...
**Video** (optional - 53% of Product of Day include video)
...
**X Handle**
- Product X handle: _______________
...
- Our story (humble, personal)
- Goals (ask for specific feedback)
...
**Helpful Links:**
- PH Launch Guide: _______________
- Our landing page: _______________
- Press kit: _______________
