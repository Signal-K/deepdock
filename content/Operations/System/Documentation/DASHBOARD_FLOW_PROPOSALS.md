...
3. Script creates `content/Operations/Daily/Active/YYYY-MM-DD.md` with only:
- project sections
...
2. Script:
- auto-tags tasks
- routes tasks -> `content/Categories/Tasks/...`
- routes notes/decisions -> `content/Categories/Docs/...`
- routes ideas -> `content/Categories/Ideas/...`
- appends backlinks under `## Routed Notes`
3. Run `🗄️ Smart Archive`.
4. Script archives to:
- `content/Operations/Daily/Archive/YYYY-MM/` (default)
- `content/Operations/Daily/Long-Term/YYYY/` (>=30 days old + no open tasks)
