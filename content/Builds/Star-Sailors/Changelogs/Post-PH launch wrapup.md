...
* Email...again mentioned... [[2025-12-26]]
...
### From Stories/user-navigation.md
...
### From Stories/Star Sailors walk-through pre-ProductHunt launch.md
- [ ] Figure out why Posthog analytics aren't working in prod 🆔 809v6f 

### From Stories/responsive-experience.md
...
### From Boards/Sprints/SSG-294.md
...
### From Sprints/SSG-294.md
- [ ] Show created/painted planet in next scene?
- [ ] Add some sort of API tool or plugin so updates can be sent directly to the "Updates" tab

### From Boards/Planet Hunters Board.md
...
### From Research/Starter deposit system.md
