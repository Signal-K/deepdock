...
# Captured from VAULT_DOCUMENTATION.md

Routed from non-daily source.
Source: [[content/Operations/Vault-Docs/VAULT_DOCUMENTATION.md|VAULT_DOCUMENTATION.md]]
...
This extracts:
- Components → `content/Categories/Projects/[project]/Components/`
- Features → `content/Categories/Projects/[project]/Features/`
- Research → `content/Categories/Projects/[project]/Research/`
...
Each project in `content/Categories/Projects/` follows this structure:
...
## Backlinks
- [[content/Operations/Vault-Docs/VAULT_DOCUMENTATION.md|Source Note]]
