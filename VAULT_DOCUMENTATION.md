...
This extracts:
- Components → `_Tasks/Projects/[project]/Components/`
- Features → `_Tasks/Projects/[project]/Features/`
- Research → `_Tasks/Projects/[project]/Research/`
...
Each project in `_Tasks/Projects/` follows this structure:
